SERVICE = test_ws_connection_java
SERVICE_CAPS = test_ws_connection_java
SPEC_FILE = test_ws_connection_java.spec
URL = https://kbase.us/services/test_ws_connection_java
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
